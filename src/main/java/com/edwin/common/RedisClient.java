...
public class RedisClient {
	...
	private void test() {
		...
		System.out.println(jedis.set("key1", "hello"));
		...
		System.out.println(shardedJedis.append("key1", "world"));
		System.out.println(shardedJedis.get("key1"));
		System.out.println(shardedJedis.del("key3"));
		System.out.println(jedis.keys("*"));
		System.out.println(shardedJedis.expire("key4", 5));
		try {
			Thread.sleep(2000);
		} catch (Exception e) {
		...
		System.out.println(shardedJedis.exists("key1"));
